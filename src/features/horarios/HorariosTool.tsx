...
import { readSheet, buildPunches, ArchivoInvalidoError } from "./parseExcel";
...
/**
 * Herramienta "Control de Horarios": procesa un Excel de fichajes y devuelve, por
 * empleado y jornada, entrada, salida, horas trabajadas y sede. Todo en el navegador.
 */
export default function HorariosTool() {
